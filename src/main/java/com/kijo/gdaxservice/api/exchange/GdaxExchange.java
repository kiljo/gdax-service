...
public interface GdaxExchange {
  ...
  public <T> T pagedGet(String endpoint, ParameterizedTypeReference<T> responseType, String beforeOrAfter,
      Integer pageNumber, Integer limit);

  public <T> List<T> getAsList(String endpoint, ParameterizedTypeReference<T[]> type);

  public <T> List<T> pagedGetAsList(String endpoint, ParameterizedTypeReference<T[]> responseType, String beforeOrAfter,
      Integer pageNumber, Integer limit);
