...
public class NewLimitOrderSingle extends NewOrderSingle {
  ...
  public NewLimitOrderSingle(BigDecimal size, BigDecimal price, Boolean post_only, String clientOid, String type,
      String side, String product_id, String stp, String funds) {
    this.size = size;
    this.price = price;
    this.post_only = post_only;
