...
public class CoinbaseAccount {
  ...
  public CoinbaseAccount(String id, String name, BigDecimal balance, String currency, String type, Boolean primary,
      Boolean active, DepositInformation wire_deposit_information, SepaDepositInformation sepa_deposit_information) {
    this.id = id;
    this.name = name;
