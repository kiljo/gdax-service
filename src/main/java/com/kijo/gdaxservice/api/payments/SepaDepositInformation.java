...
public class SepaDepositInformation {
  ...
  public SepaDepositInformation(String iban, String swift, String bank_name, String bank_address,
      String bank_country_name, String account_name, String account_address, String reference) {
    this.iban = iban;
    this.swift = swift;
