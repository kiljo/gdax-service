...
public class DepositInformation {
  ...
  public DepositInformation(String account_number, String routing_number, String bank_name, String bank_address,
      BankCountry bank_country, String account_name, String account_address, String reference) {
