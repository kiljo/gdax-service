package com.kijo.gdaxservice.api.transfers;
...
/**
 * This class is best used in conjunction with the coinbase library to get the
 * coinbase account Id's. see: https://github.com/coinbase/coinbase-java
 *
...
public class TransferService {
  ...
  public String transfer(String type, BigDecimal amount, String coinbaseAccountId) {
    return gdaxExchange.post(TRANSFER_ENDPOINT, new ParameterizedTypeReference<String>() {
